...
(1, 1, 'food, coded as Sabroso Camiguins Finest Tsokolate', 'SHL-00564', 'R10-122022-SHL-0544', 'SHL-00565', 'Samp 3', 'Samp 1', NULL, '				    	1 is the best			    				    ', '2222', NULL, 1, 1, 0, '2022-12-28 09:55:50'),
(2, 2, 'food, coded as Sabroso Camiguins Finest Tsokolate', 'SHL-00563', 'R10-122022-SHL-0544', 'SHL-00563', 'Samp 1', 'Samp 2', '2023-02-13 00:00:00', NULL, NULL, '			\n						\n			; 6 parin; 9 is the best   tt', 1, 1, 0, '2022-12-28 09:57:13'),
(3, 2, 'food, coded as WHOLE WHEAT LOAF', 'SHL-00535', 'R10-122022-SHL-0516', 'SHL-00535', NULL, NULL, '2023-02-13 00:00:00', NULL, NULL, NULL, 1, 1, 0, '2022-12-28 10:01:07'),
(4, 1, 'food, coded as WHOLE WHEAT LOAF', 'SHL-00535', 'R10-122022-SHL-0516', 'SHL-00535', NULL, NULL, NULL, '				    	4444 all the way', '				    	4444 all the way;', NULL, 1, 1, 0, '2022-12-28 10:01:26'),
(5, 1, 'Juice', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0, '2022-12-29 14:16:09'),
(6, 1, 'food, coded as Alto Peak', 'SHL-0025', 'R10-012023-SHL-0025', 'SHL-0025', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0, '2023-01-31 16:13:58'),
(7, 2, 'food, coded as Banana Chips', 'SHL-0026', 'R10-012023-SHL-0026', 'SHL-0026', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, '2023-01-31 16:32:01'),
...
(12, 0, '', 1, '2023-03-28 20:02:41', 0),
(13, 0, '', 1, '2023-03-28 20:06:18', 0),
(14, 0, '', 1, '2023-03-28 20:06:27', 0),
(15, 0, '', 1, '2023-03-28 20:06:47', 0),
(16, 0, '', 1, '2023-03-28 20:09:13', 0);
...
(11, 7, 103, 'Milktea is lifer', 21, '2023-03-15 18:30:11');
...
--
ALTER TABLE `tbl_paired_difference_answers`
  MODIFY `pda_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `tbl_paired_difference_test_sample`
--
ALTER TABLE `tbl_paired_difference_test_sample`
  MODIFY `pdt_sample_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tbl_paired_diff_attr`
--
ALTER TABLE `tbl_paired_diff_attr`
  MODIFY `pdattr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `tbl_triangle_test_answers`
  MODIFY `tta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
